...
pub fn has_${syscall}_syscall(arch: SupportedArch) -> bool {
    match arch {
        ...
        X86_64 => x64_arch::${syscall_upper} >= 0,
    }
}
""")
...
pub fn is_${syscall}_syscall(syscallno: i32, arch: SupportedArch) -> bool {
    match arch {
        ...
        X86_64 => syscallno >= 0 && syscallno == x64_arch::${syscall_upper},
    }
}
""")
...
pub fn syscall_number_for_${syscall}(arch: SupportedArch) -> i32 {
    match arch {
        X86 => {
            debug_assert!(x86_arch::${syscall_upper} >= 0);
            x86_arch::${syscall_upper}
        }
        X86_64 => {
            debug_assert!(x64_arch::${syscall_upper} >= 0);
            x64_arch::${syscall_upper}
        },
    }
}
""")
...
def write_syscall_helper_functions(f):
    ...
    f.write("// This file has been autogenerated. DO NOT MODIFY!\n")
    f.write("use crate::kernel_abi::SupportedArch;\n")
    f.write("use crate::kernel_abi::SupportedArch::*;\n")
    f.write("use crate::x86_arch;\n")
    f.write("use crate::x64_arch;\n")
    for name, obj in syscalls.all():
        write_helpers(name)
