...
// - PTRACE_* related #defines are commented out below
...
const unsigned int _USBDEVFS_ALLOC_STREAMS = USBDEVFS_ALLOC_STREAMS; 
const unsigned int _USBDEVFS_CLAIMINTERFACE = USBDEVFS_CLAIMINTERFACE; 
const unsigned int _USBDEVFS_CLEAR_HALT = USBDEVFS_CLEAR_HALT; 
const unsigned int _USBDEVFS_DISCONNECT_CLAIM = USBDEVFS_DISCONNECT_CLAIM; 
const unsigned int _USBDEVFS_FREE_STREAMS = USBDEVFS_FREE_STREAMS; 
const unsigned int _USBDEVFS_RELEASEINTERFACE = USBDEVFS_RELEASEINTERFACE; 
const unsigned int _USBDEVFS_SETINTERFACE = USBDEVFS_SETINTERFACE; 
const unsigned int _USBDEVFS_SETCONFIGURATION = USBDEVFS_SETCONFIGURATION; 
const unsigned int _USBDEVFS_SUBMITURB = USBDEVFS_SUBMITURB; 
const unsigned int _USBDEVFS_IOCTL = USBDEVFS_IOCTL;
const unsigned int _USBDEVFS_CONTROL = USBDEVFS_CONTROL;
const unsigned int _USBDEVFS_GET_CAPABILITIES = USBDEVFS_GET_CAPABILITIES;
...
const unsigned int _TIOCGPTLCK = TIOCGPTLCK;
const unsigned int _TIOCGEXCL = TIOCGEXCL;
