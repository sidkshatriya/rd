...
pub const RD_PAGE_ADDR: u32 = 0x70000000;
pub const RD_PAGE_SYSCALL_STUB_SIZE: u32 = 3;
pub const RD_PAGE_SYSCALL_INSTRUCTION_END: u32 = 2;

pub const fn RD_PAGE_SYSCALL_ADDR(index: u32) -> u32 {
    RD_PAGE_ADDR + RD_PAGE_SYSCALL_STUB_SIZE * index
}

pub const RD_PAGE_SYSCALL_TRACED: u32 = RD_PAGE_SYSCALL_ADDR(0);
pub const RD_PAGE_SYSCALL_PRIVILEGED_TRACED: u32 = RD_PAGE_SYSCALL_ADDR(1);
pub const RD_PAGE_SYSCALL_UNTRACED: u32 = RD_PAGE_SYSCALL_ADDR(2);
pub const RD_PAGE_SYSCALL_UNTRACED_REPLAY_ONLY: u32 = RD_PAGE_SYSCALL_ADDR(3);
pub const RD_PAGE_SYSCALL_UNTRACED_RECORDING_ONLY: u32 = RD_PAGE_SYSCALL_ADDR(4);
pub const RD_PAGE_SYSCALL_PRIVILEGED_UNTRACED: u32 = RD_PAGE_SYSCALL_ADDR(5);
pub const RD_PAGE_SYSCALL_PRIVILEGED_UNTRACED_REPLAY_ONLY: u32 = RD_PAGE_SYSCALL_ADDR(6);
pub const RD_PAGE_SYSCALL_PRIVILEGED_UNTRACED_RECORDING_ONLY: u32 = RD_PAGE_SYSCALL_ADDR(7);
pub const RD_PAGE_FF_BYTES: u32 = RD_PAGE_ADDR + RD_PAGE_SYSCALL_STUB_SIZE * 8;

/// PRELOAD_THREAD_LOCALS_ADDR should not change.
/// Tools depend on this address.
pub const PRELOAD_THREAD_LOCALS_ADDR: u32 = RD_PAGE_ADDR + PAGE_SIZE;
