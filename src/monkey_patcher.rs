...
fn erase_section<'a>(elf_file: &Elf<'a>, t: &RecordTask, section_name: &str) {
...
fn obliterate_debug_info<'a>(elf_file: &Elf<'a>, t: &RecordTask) {
...
fn locate_and_verify_kernel_vsyscall(t: &RecordTask, elf_file: &Elf) -> RemotePtr<Void> {
